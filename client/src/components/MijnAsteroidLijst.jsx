          ...
          return (
            <Query query={GET_ABBONEMENTEN_USER} context={Options}>
              {({ loading, error, data: { user } }) => {
                ...
                return (
                  <>
                    <h2 className={styles.titel}>Stopgezette abbonementen</h2>
                        ...
                        return abbonement.active === false ? (
                          ...
                          >
                            ...
                            <div className={styles.buttonflex}>
                              <button className={styles.button}>Huren</button>
                            </div>
                          </li>
                        ) : (
                          <></>
...
export default MijnAsteroidLijst;
